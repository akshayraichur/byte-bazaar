...
const Home = () => {
  console.log(PRODUCTS.filter((p) => p.tag === "best-seller"));
  return (
        ...
        <div className="header">
          <div className="header-text-container">
            ...
            <p className="header-description">
              We are thrilled to have you, Our platform is designed to provide you with a seamless shopping experience,
              ensuring that you have access to a wide range of top-quality tech products at your fingertips.
            </p>
